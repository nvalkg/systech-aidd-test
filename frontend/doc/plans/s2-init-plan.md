...
### 16. Добавление ссылки на план в roadmap
...
```markdown
| **FE-SPRINT-2** | Каркас frontend проекта | 🚧 In Progress | [План](plans/s2-init-plan.md) |
```

### 17. Проверка всех package.json команд
...
### 18. Финальная актуализация frontend-roadmap.md
...
- ✅ Все package.json команды работают корректно
...
- `frontend/doc/plans/s2-init-plan.md` (этот план)
...
- `frontend/doc/frontend-roadmap.md` (добавить ссылку на план, затем обновить статус после завершения)
